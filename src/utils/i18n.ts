...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'agent.chat_prompt': 'What would you like to talk about?',
    ...
    // MediaBind / Connect
    'media.username_prompt': 'Please enter your username for the streaming service.',
    'media.password_prompt': 'Now enter your password. (Your message will be processed securely.)',
    'media.not_configured': '❌ Media services are not configured. Please contact the bot admin.',
    'media.already_bound': 'You already have a linked account ({username}). Use disconnect first if you want to relink.',
    'media.connect_start': 'Let\'s link your media account. Please enter your username:',
    'media.connected': '✅ Account linked successfully!',
    'media.connected_username': 'Username:',
    'media.notify_hint': 'Would you like to receive media notifications in this chat? Use the notify command to manage notification preferences.',
    'media.auth_failed': '❌ Authentication failed:',
    'media.auth_retry': 'Please check your credentials and try again.',
    'media.unlinked': '✅ Media account unlinked successfully.',
    'media.no_binding': 'You don\'t have any linked media accounts.',
    'media.no_binding_status': 'You don\'t have any linked media accounts. Use connect to link your account.',
    'media.notify_here': '✅ This chat will now receive media notifications.',
    'media.notify_add_prompt': 'Please specify a room ID.',
    'media.notify_added': '✅ Room {room} will now receive media notifications.',
    'media.notify_removed': '✅ Room {room} will no longer receive media notifications.',
    'media.notify_not_found': 'No notification subscription found for that room.',
    'media.notify_list_empty': 'You have no notification subscriptions.',
    'media.notify_types_all': 'all',
    'media.notify_list_header': '📋 *Your notification subscriptions:*',
    'media.notify_actions_list': 'Available notify actions: here, add, remove, list',
    'media.actions_list': 'Available actions: connect, disconnect, notify, status',
    'media.admin_label': '(Admin)',
    'media.status_header': '📋 *Linked Accounts:*',
    'media.status_notify_header': '📬 *Notification Rooms:*',
  ...
  id: {
    ...
    'agent.chat_prompt': 'Tentukan apa yang ingin kamu diskusikan.',
    ...
    // MediaBind
    'media.username_prompt': 'Silakan masukkan username layanan streaming Anda.',
    'media.password_prompt': 'Sekarang masukkan password Anda. (Pesan Anda akan diproses dengan aman.)',
    'media.not_configured': '❌ Layanan media belum dikonfigurasi. Hubungi admin bot.',
    'media.already_bound': 'Anda sudah memiliki akun terhubung ({username}). Gunakan disconnect terlebih dahulu jika ingin menghubungkan ulang.',
    'media.connect_start': 'Mari hubungkan akun media Anda. Silakan masukkan username:',
    'media.connected': '✅ Akun berhasil dihubungkan!',
    'media.connected_username': 'Username:',
    'media.notify_hint': 'Ingin menerima notifikasi media di obrolan ini? Gunakan perintah notify untuk mengelola preferensi notifikasi.',
    'media.auth_failed': '❌ Otentikasi gagal:',
    'media.auth_retry': 'Periksa kredensial Anda dan coba lagi.',
    'media.unlinked': '✅ Akun media berhasil dilepas.',
    'media.no_binding': 'Anda tidak memiliki akun media yang terhubung.',
    'media.no_binding_status': 'Anda tidak memiliki akun media yang terhubung. Gunakan connect untuk menghubungkan.',
    'media.notify_here': '✅ Obrolan ini akan menerima notifikasi media.',
    'media.notify_add_prompt': 'Silakan tentukan ID ruangan.',
    'media.notify_added': '✅ Ruangan {room} akan menerima notifikasi media.',
    'media.notify_removed': '✅ Ruangan {room} tidak akan menerima notifikasi media lagi.',
    'media.notify_not_found': 'Tidak ditemukan langganan notifikasi untuk ruangan tersebut.',
    'media.notify_list_empty': 'Anda tidak memiliki langganan notifikasi.',
    'media.notify_types_all': 'semua',
    'media.notify_list_header': '📋 *Langganan Notifikasi Anda:*',
    'media.notify_actions_list': 'Aksi notify yang tersedia: here, add, remove, list',
    'media.actions_list': 'Aksi yang tersedia: connect, disconnect, notify, status',
    'media.admin_label': '(Admin)',
    'media.status_header': '📋 *Akun Terhubung:*',
    'media.status_notify_header': '📬 *Ruangan Notifikasi:*',
