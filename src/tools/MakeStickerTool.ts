...
export class MakeStickerTool extends BaseTool {
  ...
  async execute(args: Record<string, any>, ctx: MessageContext): Promise<string> {
    ...
    try {
      ...
      const author = args.author || 'ElastraGPBOT v7';
