-- This file was superseded by 0014_media_integration.sql and is no longer referenced by the journal.
-- It is kept here as an orphaned artifact only. Do NOT apply it manually.
...
CREATE INDEX `notification_subs_service_idx` ON `notification_subscriptions` (`service_type`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `user_identities_lid_idx` ON `user_identities` (`lid`);--> statement-breakpoint
CREATE UNIQUE INDEX `user_identities_pn_idx` ON `user_identities` (`pn`);--> statement-breakpoint
