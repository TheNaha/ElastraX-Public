...
--> statement-breakpoint
INSERT INTO `__new_chat_rooms`("id", "platform", "language", "system_prompt", "context_limit", "temperature", "max_tokens", "allow_tools", "auto_reply_all", "created_at") SELECT "id", "platform", "language", "system_prompt", "context_limit", "temperature", "max_tokens", "allow_tools", "auto_reply_all", "created_at" FROM `chat_rooms`;--> statement-breakpoint
